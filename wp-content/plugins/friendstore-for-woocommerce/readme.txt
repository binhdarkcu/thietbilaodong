...
Contributors: vietfriendteam
Plugin URI: http://team.vietfriend.info/
Tags: friendstore, woocommerce, shipping, vietnam, checkout, shop, store, ghn, ghtk, giao hang nhanh, giao hang tiet kiem
...
== Description ==
Is an extension of WooCommerce that support customizing addresses and integrating delivery units (GHN & GHTK) in Vietnam.
...
▪ Address book (like tiki, lazada, shopee...)
▪ Calculate shipping fee on product detail
▪ Integrating Viettel Post unit (ViettelPost express)
▪ Integrating Momo method payment (MoMo E-Wallet)

**USEFUL LINKS:**

▪ Website: [store.vietfriend.info](https://store.vietfriend.info/?utm_source=wporg&utm_medium=cpc&utm_campaign=friendstore_plugin&utm_content=wporg_demo) *(Account: demo/123456)*
...
1. Notice after setup Plugin
2. Update Store address (pro)
3. Update Shipping settings (pro)
4. Calculate Shipping Cost on Cart page (pro)
5. Calculate Shipping Cost on Checkout page (pro)
...
= 1.0.0 =
please update the settings at admin area & settings tab before operating your website.
