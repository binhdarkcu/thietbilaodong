...
class FoW_Ultility {
    ...
    public static function show_wards_option_by_district_id($district_id) {
        $district_id = sanitize_key($district_id);
    ...
    public static function get_store_info() {
        ...
        $store_info['full_address'] = implode(', ', array_filter(array($store_info['address'], $store_info['ward'], $store_info['district'], $store_info['district'])));
