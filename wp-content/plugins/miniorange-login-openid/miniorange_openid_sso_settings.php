...
class miniorange_openid_sso_settings
{
    function __construct()
    {
        ...
        add_option('app_pos_premium','apple#wordpress#disqus#pinterest#spotify#tumblr#twitch#vimeo#kakao#discord#dribbble#flickr#line#meetup#stackexchange');
...
Thank you.';
    ...
    function mo_openid_plugin_settings_style() {
        wp_enqueue_style( 'mo_openid_admin_settings_style', plugins_url('includes/css/mo_openid_style.css?version=7.2.7', __FILE__));
    ...
    {
        wp_enqueue_style( 'mo-wp-style',plugins_url('includes/css/mo_openid_style.css?version=7.2.7', __FILE__), false );
        wp_enqueue_style( 'mo-wp-bootstrap-social',plugins_url('includes/css/bootstrap-social.css', __FILE__), false );
