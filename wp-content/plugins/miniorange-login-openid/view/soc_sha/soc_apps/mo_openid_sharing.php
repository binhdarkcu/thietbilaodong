...
<form id="social_share" name="social_share" method="post" action="">
    ...
    <div class="mo_openid_table_layout">
        <table style="width: 100%;">
            <tr id="sel_apps">
                <td><h3 >Select Social Apps </h3>
                    <table style="width: 100%">
                        <p style="font-size: 17px;">Select applications to enable social sharing</p>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="width:20%">
                                ...
                                <label class="mo_openid_checkbox_container">Facebook
                            ...
                            <td style="width:20%">
                                <label class="mo_openid_checkbox_container">Twitter.
                                    <input type="checkbox"
                            ...
                            <td style="width:20%">
                                ...
                                <label class="mo_openid_checkbox_container">Google
                            ...
                            <td style="width:20%">
                                ...
                                <label class="mo_openid_checkbox_container">Vkontakte
                            ...
                            <td style="width:20%">
                                ...
                                <label class="mo_openid_checkbox_container">Tumblr
                                    <input type="checkbox"
                        ...
                        <tr>
                            <td style="width:20%">
                                ...
                                <label class="mo_openid_checkbox_container">StumbleUpon
                            ...
                            <td style="width:20%">
                                ...
                                <label class="mo_openid_checkbox_container">LinkedIn
                            ...
                            <td style="width:20%">
                                ...
                                <label class="mo_openid_checkbox_container">Pinterest
                            ...
                            <td style="width:20%">
                                ...
                                <label class="mo_openid_checkbox_container">Pocket
                        ...
                        <tr>
                            <td style="width:20%">
                                ...
                                <label class="mo_openid_checkbox_container">Digg
                            ...
                            <td style="width:20%">
                                ...
                                <label class="mo_openid_checkbox_container">Delicious
                            ...
                            <td style="width:20%">
                                ...
                                <label class="mo_openid_checkbox_container">Odnoklassniki
                            ...
                            <td style="width:20%">
                                ...
                                <label class="mo_openid_checkbox_container">Email
                            ...
                            <td style="width:20%">
                                ...
                                <label class="mo_openid_checkbox_container">Print
                        ...
                        <tr>
                            <td style="width:20%">
                                ...
                                <label class="mo_openid_checkbox_container">Whatsapp
            ...
            <tr>
                <td>
                    <br/>
                    <p class="mo_openid_note_style"><strong>*NOTE:</strong><br/>Custom background: This will
    ...
    <script>
        //to set heading name
        jQuery('#mo_openid_page_heading').text('Social Sharing');
    </script>
    <?php
    }
    ?>
