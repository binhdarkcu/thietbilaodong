           ...
           value="<?php echo wp_create_nonce( 'mo-openid-enable-share-display-nonce' ); ?>"/>
            ...
            <div class="mo_openid_table_layout" >
                <table style="height: 200%">
                    ...
                    <div id="above">
           <strong style="font-size: 14px">Select the options where you want to display social share icons</strong>
                    </div>
                    <div id="upleft" style="font-size: 14px;">


                        <label class="mo_openid_checkbox_container"> Home Page
                        ...
                        <label class="mo-openid-radio-container">Before content
                        ...
                        <label class="mo-openid-radio-container">After content
                        ...
                        <label class="mo-openid-radio-container">Both before and after content
                        ...
                        <label class="mo_openid_checkbox_container"> Blog Post
                        ...
                        <label class="mo_openid_checkbox_container"> Static Pages
                        ...
                        <label class="mo_openid_checkbox_container" ">  WooCommerce Individual Product Page(Top)
                    ...
                    <div id="upright" style="font-size: 14px;">
                        ...
                        <label class="mo_openid_checkbox_container"> WooCommerce Individual Product Page
                        ...
                        <label class="mo_openid_checkbox_container" ">  BBPress Forums Page
                        ...
                        <label class="mo_openid_checkbox_container"> BBPress Topic Page
                        ...
                        <label class="mo_openid_checkbox_container"> BBPress Reply Page
...
<div style="margin-left: 8%">
                    ...
                    <div id="below">
                        <p class="mo_openid_note_style" ><strong>NOTE:</strong>  The icons in above pages will be placed horizontally. For vertical icons, add <b>miniOrange Sharing - Vertical</b> widget from Appearance->Widgets.</p>

                    </div>
                    <tr>
                        <td><br /><b><input type="submit" name="submit" value="Save" style="width:150px;background-color:#0867b2;color:white;box-shadow:none;text-shadow: none;"  class="button button-primary button-large" /></b>
                        </td>
                    </tr>
