...
function mo_openid_customize_icons(){
    $url_uu = site_url().'/wp-content/plugins/miniorange-login-openid/includes/css/font-awesome.css';
    ?>
    ...
    <input type="hidden" name="mo_openid_enable_customize_text_nonce"
           value="<?php echo wp_create_nonce( 'mo-openid-enable-customize-text-nonce' ); ?>"/>
            ...
            <table style="width: 100%">
                <tr>
                    <td>
                        ...
                        <p style="font-size: 17px">Customize shape, size and background for sharing icons</p>
                    </td>
                </tr>
                <tr>
                    <td>
                        <table style="width=100%">
                            <tr >
                                <td class="mo_openid_fix_fontsize_semiheading" style="width: 30%">Shape</td>
                                <td class="mo_openid_fix_fontsize_semiheading" style="width: 30%">Theme</td>
                                <td class="mo_openid_fix_fontsize_semiheading" style="width: 25%">Space between Icons</td>
                                <td class="mo_openid_fix_fontsize_semiheading" style="width: 30%">Size of Icons</td>
                            </tr>
...
<!--                                    </select>-->
                                ...
                                <td style=" width=30%">
                                 ...
                                 <br>
                                    ...
                                    <label class="mo-openid-radio-container">No background*
                            ...
                            <tr>
                               <td colspan="4" class="mo_openid_note_style" style="width: 328%; padding: 10px;"><b>*NOTE:</b> Custom background: This will change the background color of share icons.<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; No background:This will remove the background color of share icons.</td>
                            </tr>
            ...
            <hr>
                    <b class="share_text">Select color for share heading:</b>
            ...
            <br><br>
                    <b class="share_text" >Enter text to show above share widget:</b>
            ...
            <br><br>
                    <b class="share_text" >Enter your twitter Username (without @):</b>
            ...
            <br><br>
                    ...
                    <b class="share_text">Enter the Email subject (email share):</b>
            ...
            <br><br>
                    ...
                    <b class="share_text">Enter the Email body (add ##url## to place the URL):</b>
    ...
    <script>
        //to set heading name
        jQuery('#mo_openid_page_heading').text('Customize text for Social Share Icons');
    </script>
