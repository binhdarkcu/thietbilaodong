...
function mo_openid_login_shortcodes(){
            ...
            <tr>
                <td>
                    <div id="mo_openid_login_shortcode" style="font-size:13px !important">
                        <h4>Use social login Shortcode in the content of required page/post where you want to display Social Login Icons.</h4>
                        ...
                        <b>Square Shape Example:</b> <code id='2'>[miniorange_social_login shape="square" theme="default" space="4" size="35"]</code><i style= "width: 11px;height: 9px;padding-left:2px;padding-top:3px" class="mofa mofa-fw mofa-lg mofa-copy mo_copy mo_copytooltip" onclick="copyToClipboard(this, '#2', '#shortcode_url1_copy')"><span id="shortcode_url1_copy" class="mo_copytooltiptext">Copy to Clipboard</span></i><br/><br/>
                        ...
                        <b>Round Shape Example:</b> <code id='3'>[miniorange_social_login shape="round" theme="default" space="4" size="35"]</code><i style= "width: 11px;height: 9px;padding-left:2px;padding-top:3px" class="mofa mofa-fw mofa-lg mofa-copy mo_copy mo_copytooltip" onclick="copyToClipboard(this, '#3', '#shortcode_url2_copy')"><span id="shortcode_url2_copy" class="mo_copytooltiptext">Copy to Clipboard</span></i><br/><br/>
                        ...
                        <a class=" login-button" rel="nofollow" title="login with instagram"><img alt="Instagram" style="width:35px !important;height: 35px !important;margin-left: 4px !important" src="<?php echo plugin_url.'/instagram.png'?>" class=" login-button round"></a><br/><br/>
                        ...
                        <b>Vertical View Example:<br/></b><code id='4'>[miniorange_social_login shape="longbuttonwithtext" theme="default" space="8" width="180" height="35" color="000000"]</code><i style= "width: 11px;height: 9px;padding-left:2px;padding-top:3px" class="mofa mofa-fw mofa-lg mofa-copy mo_copy mo_copytooltip" onclick="copyToClipboard(this, '#4', '#shortcode_url3_copy')"><span id="shortcode_url3_copy" class="mo_copytooltiptext">Copy to Clipboard</span></i><br/><br/>
                        ...
                        <b>Example:</b><code id='6'>[miniorange_social_login apps="vk,google,fb" shape="longbuttonwithtext" view="horizontal" theme="default" space="10" width="200" height="35" color="000000"]</code><i style= "width: 11px;height: 9px;padding-left:2px;padding-top:3px" class="mofa mofa-fw mofa-lg mofa-copy mo_copy mo_copytooltip" onclick="copyToClipboard(this, '#6', '#shortcode_url5_copy')"><span id="shortcode_url5_copy" class="mo_copytooltiptext">Copy to Clipboard</span></i><br/><br/>
                        ...
                        <div class="mo_openid_note_style">
                                <b>Note:</b>
                                1. If you are not registered with miniOrange and <b>Custom App</b> is also not set up then please register with us first or set up <b>Custom App</b> otherwise the buttons will be <b>disabled</b><br/>
                                2. If Facebook is selected then please set up <b>Custom App</b> first otherwise the buttons will be <b>disabled</b>
                                <br/>
                        </div><br>
    ...
    <script>
        //to set heading name
        jQuery('#mo_openid_page_heading').text('Social Login Shortcodes');
