...
function mo_openid_email_notification(){
        ...
        <br/><div>
            <form>
                ...
                <input type="hidden" name="mo_openid_enable_email_setting_nonce"
                       value="<?php echo wp_create_nonce( 'mo-openid-enable-email-setting-nonce' ); ?>"/>
            <div class="mo_openid_highlight">
                <h3 style="margin-left: 1%;line-height: 210%;color: white;" id="mo_openid_send_email_admin_collapse" onclick="show_disable_send_email_admin(this.id)">Send mail to Admin<span class="dashicons dashicons-arrow-up toggle-div1" ></span></h3>
                <style>
                    .toggle-div1{
                        float:inherit;
                        font-size:1.5em;
            ...
            <div id="mo_send_email_admin">
                <b class="mo_openid_note_style">*NOTE: This feature requires SMTP to be setup.</b><br/>
                <label class="mo_openid_checkbox_container_disable"><b>Enable Email Notification to Admin - on User Registration*</b>
                    <input type="checkbox"  />
                    <span class="mo_openid_checkbox_checkmark_disable"></span>
                </label>
                <b>If you want to send Email Notification to multiple admins, enter emails of all admins here:</b><br><br>(If left empty only administrator gets email)
            ...
            <div class="mo_openid_highlight">
                <h3 style="margin-left: 1%;line-height: 210%;color: white;" id="mo_openid_send_email_user_collapse" onclick="show_disable_send_email_user(this.id)">Send mail to User<span class="dashicons dashicons-arrow-up toggle-div1" ></span></h3>
                <style>
                    .toggle-div1{
                        float:inherit;
                        font-size:1.5em;
            ...
            <div  id="mo_send_email_user">
                ...
                <b class="mo_openid_note_style">*NOTE: This feature requires SMTP to be setup.</b><br/>
                <label class="mo_openid_checkbox_container_disable"><b>Email Notification to User on User Registration*</b>
                    <input type="checkbox"  />
                    <span class="mo_openid_checkbox_checkmark_disable"></span>
                </label>
              ...
              <b>Email Subject:</b>
                ...
                wp_editor( $content, $editor_id ,$editor_height);
                ?>
                <input disabled type="button" name="submit" value="Save" style="width:100px;"  class="button button-primary button-large" />
                <br><br>
            </div>
            </form>
        </div>
    ...
    <script>
        //to set heading name
        jQuery('#mo_openid_page_heading').text('Email Notification');
