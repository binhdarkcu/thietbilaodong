    ...
    <form id="registration" name="registration" method="post" action="">
        ...
        <div class="mo_openid_table_layout">
            ...
            <div>
                ...
                <label style="cursor: auto" class="mo_openid_note_style"> Use Role Mapping to assign this role to the all users registering through Social Login. According to the role mapped user will be granted role on the website.</label>
            </div><br><hr>
            ...
            <div>
                ...
                <label style="cursor: auto" class="mo_openid_note_style">This feature requires SMTP to be configured.</label>
            </div>
            <br/><hr>
