...
function mo_openid_linkSocialAcc(){
        ...
        <form id="account_linking" name="premium_feature" method="post" action="" xmlns="http://www.w3.org/1999/html">
            ...
            <table>
                <tr>
                    <td colspan="2">
                        <div>
                            <label class="mo_openid_note_style"> Enable account linking to let your users link their Social accounts with existing WordPress account. Users will be prompted with the option to either link to any existing account using WordPress login page or register as a new user.</label><br/>
                            <label style="cursor: auto" class="mo_openid_checkbox_container">Enable linking of Social Accounts
                ...
                <tr><td colspan="2"></td></tr>
                    <tr id="account_link_customized_text"><td colspan="2"><h3 style="float: left">Customize Text for Account Linking</h3><a style="float: right;margin-right: 325px;margin-top: 20px" onclick="customize_account_linking_img()">Preview Account Linking form</a></td></tr>
                    <tr id="acc_link_img"><td colspan="2"></td></tr>
                    <tr id="account_link_customized_text"><td class="mo_openid_fix_fontsize" style="width: 40%">1. Enter title of Account linking form:</td><td><input <?php echo $disable ?> class="mo_openid_textfield_css" style="border: 1px solid ;border-color: #0867b2" type="text" name="mo_account_linking_title" value="<?php echo esc_attr(get_option('mo_account_linking_title')); ?>" /></td></tr>
                    <tr id="account_link_customized_text"><td class="mo_openid_fix_fontsize" style="width: 40%">2. Enter button text for create new user:</td><td><input <?php echo $disable ?> class="mo_openid_textfield_css" style="border: 1px solid ;border-color: #0867b2" type="text" name="mo_account_linking_new_user_button" value="<?php echo esc_attr(get_option('mo_account_linking_new_user_button')); ?>"/></td></tr>
                    <tr id="account_link_customized_text">
                        <td class="mo_openid_fix_fontsize" style="width: 40%">
                            3. Enter button text for Link to existing user:</td><td><input <?php echo $disable ?> class="mo_openid_textfield_css" style="border: 1px solid ;border-color: #0867b2" type="text" name="mo_account_linking_existing_user_button" value="<?php echo esc_attr(get_option('mo_account_linking_existing_user_button')); ?>"/></td></tr>
                <tr><td></td></tr>
                    <tr id="account_link_customized_text"><td class="mo_openid_fix_fontsize" colspan="2">4. Enter instruction to Create New Account :<br/><input <?php echo $disable ?> class="mo_openid_textfield_css" style="border: 1px solid ;border-color: #0867b2;width: 98%" type="text" name="mo_account_linking_new_user_instruction" value="<?php echo esc_attr(get_option('mo_account_linking_new_user_instruction')); ?>"/>
                        </td>
                    </tr>
                <tr><td></td></tr>
                    <tr id="account_link_customized_text">
                        <td class="mo_openid_fix_fontsize" colspan="2">
                            5. Enter instructions to link to an existing account :<br/><input <?php echo $disable ?> class="mo_openid_textfield_css" style="border: 1px solid ;border-color: #0867b2;width: 98%" type="text" name="mo_account_linking_existing_user_instruction" value="<?php echo esc_attr(get_option('mo_account_linking_existing_user_instruction')); ?>"/>
                        </td>
                    </tr>
                <tr><td></td></tr>
                    <tr id="account_link_customized_text"><td disabled class="mo_openid_fix_fontsize" colspan="2">Enter extra instructions for account linking :<br/><input <?php echo $disable ?> class="mo_openid_textfield_css" style="border: 1px solid ;border-color: #0867b2;width: 98%" style="width:98%;margin-left: 0px;" type="text" name="mo_account_linking_extra_instruction" value="<?php echo esc_attr(get_option('mo_account_linking_extra_instruction')); ?>"/>
                        </td>
                    </tr>
                        <tr id="disp_logo"><td colspan="2"> <br/>
                                <label class="mo_openid_checkbox_container">Display miniOrange logo with social login icons on account completion forms
                                ...
                                <br/></td></tr>
                                  <tr id="save_btn"><td><br/><input <?php echo $disable?> type="submit" name="submit" value="Save" style="width:150px;text-shadow: none;background-color:#0867b2;color:white;box-shadow:none;"  class="button button-primary button-large" /></td></tr>
    ...
    <script>
        //to set heading name
        jQuery('#mo_openid_page_heading').text('Link Social Account');
