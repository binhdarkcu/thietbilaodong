...
function mo_openid_customise_social_icons(){
            ...
            <div style="float: left;width: 55%;">
                <div style="width: 100%;">
                    <div style="float:left;width:50%;">
                        ...
                        <label class="mo-openid-radio-container">Round
                        ...
                        <label class="mo-openid-radio-container">Rounded Edges
                        ...
                        <label class="mo-openid-radio-container">Square
                            ...
                            <span class="mo-openid-radio-checkmark"></span></label>
                        <label class="mo-openid-radio-container">Long Button
                    ...
                    <div style="float: right; width: 50%;">
                        ...
                        <label class="mo-openid-radio-container">Default
                        ...
                        <label class="mo-openid-radio-container">Custom background*
                ...
                <div style="width: 85%; float: left" class="mo_openid_note_style"><strong>*Custom background:</strong> This will change the background color of login icons.</div>
                <div style="width: 100%; float: left">
                    <div style="float:left;width:50%; margin-top: 5%">
                        ...
                        <div id="long_button_size">
                            Width: &nbsp;<input class="mo_openid_textfield_css" style="border: 1px solid ;border-color: #0867b2;width: 16%;margin-bottom: 3px" id="mo_login_icon_width" onkeyup="moLoginWidthValidate(this)" name="mo_login_icon_custom_width" type="text" value="<?php echo esc_attr(get_option('mo_login_icon_custom_width'))?>" >
                            ...
                            Height:&nbsp;<input class="mo_openid_textfield_css" style="border: 1px solid ;border-color: #0867b2;width: 16%;margin-bottom: 3px" id="mo_login_icon_height" onkeyup="moLoginHeightValidate(this)" name="mo_login_icon_custom_height" type="text" value="<?php echo esc_attr(get_option('mo_login_icon_custom_height'))?>" >
                            <input id="mo_login_height_plus" type="button" value="+" onmouseup="moLoginPreview(document.getElementById('mo_login_icon_width').value,setLoginTheme(),setLoginCustomTheme(),document.getElementById('mo_login_icon_custom_color').value,document.getElementById('mo_login_icon_space').value,document.getElementById('mo_login_icon_height').value,document.getElementById('mo_login_icon_custom_boundary').value)" >
                            <input id="mo_login_height_minus" type="button" value="-" onmouseup="moLoginPreview(document.getElementById('mo_login_icon_width').value,setLoginTheme(),setLoginCustomTheme(),document.getElementById('mo_login_icon_custom_color').value,document.getElementById('mo_login_icon_space').value,document.getElementById('mo_login_icon_height').value,document.getElementById('mo_login_icon_custom_boundary').value)" ><br/>
                            Curve:&nbsp;&nbsp;<input class="mo_openid_textfield_css" style="border: 1px solid ;border-color: #0867b2;width: 16%;margin-bottom: 3px" id="mo_login_icon_custom_boundary" onkeyup="moLoginBoundaryValidate(this)" name="mo_login_icon_custom_boundary" type="text" value="<?php echo esc_attr(get_option('mo_login_icon_custom_boundary'))?>" />
                    ...
                    <div style="width: 50%;float: right;margin-top: 5%">
                        <label style="font-size: 1.2em;"><b>Space between Icons</b></label>
                ...
                <div style="width: 100%; float: left">
                    ...
                    <div style="width: 100%">
                        <div style="width: 40%; float: left">
                            <label class="mo_openid_fix_fontsize">Select color for customize text:</label>
                        </div>
                    ...
                    <div style="width: 100%; margin-top: 12%">
                        <div style="width: 100%;">
                            <label class="mo_openid_fix_fontsize">Enter text to show above login widget:</label>
                    ...
                    <div style="width: 100%; margin-top: 2%" id="long_button_text">
                        <div style="width: 100%; float: left">
                            <label class="mo_openid_fix_fontsize">Enter text to show on your login buttons:</label>
                ...
                <div style="width: 100%; float: left">
                    ...
                    <div style="width: 100%;">
                        <div style="width: 100%; float: left">
                            <label class="mo_openid_fix_fontsize">Enter text to show before the logout link. Use ##username## to display current username:</label> <br>
                    ...
                    <div style="width: 100%; margin-top: 15%" id="long_button_text">
                        <br>
                        <div style="width: 100%; float: left">
                            <label class="mo_openid_fix_fontsize">Enter text to show as logout link:</label>
    ...
    <script>
        //to set heading name
        jQuery('#mo_openid_page_heading').text('Customize Login Icons');
