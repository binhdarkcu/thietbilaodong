        ...
        <div class="grid">
            <div class="col100 red">
                <table class="table mo_table-bordered-license mo_table-striped-license">
                    ...
                    <tr>
                        <td><a style="cursor: pointer" onclick="mo_openid_support_form(this)">Click here to Contact Us</a></td>
                    </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="col300 red">
                <table class="table mo_table-bordered-license mo_table-striped-license">
                    ...
                    <tr>
                        <td><div class="mo_openid_tooltip" style="padding-left: 40px;">24 Custom Social Login Apps <i class="mofa mofa-commenting " style="font-size:18px;color:#85929E"></i><span class="mo_openid_tooltiptext"style="width:100%;"> Using the custom app tab, you can set up your own app id and secret in the plugin. Login flow will not involve miniOrange in between. Login flow will go from plugin to social media application and then back to plugin.<br>24 custom apps are <span id="mo_openid_dots3">...</span><span id="mo_openid_more3" style="display:none" ><br>Facebook,Google,vkontakte,twitter,linkedin,<br>amazon,windowslive,yahoo,apple,disqus,<br>instagram,wordpress,pinterest,spotify,<br>tumblr,
