    ...
    <div>
        <table>
            <tr>
                ...
                <td> <a id="addon" style="margin-top: 23px;background: #FFA335;border-color: #FFA335;color: white;" class="button" <?php echo $active_tab == 'add_on' ? 'nav-tab-active' : ''; ?>" href="<?php echo add_query_arg( array('tab' => 'add_on'), $_SERVER['REQUEST_URI'] ); ?>">Add On</a></td>
                <td> <a id="pricing" style="margin-top: 23px;background: #FFA335;border-color: #FFA335;color: white;" class="button"<?php echo $active_tab == 'licensing_plans' ? 'nav-tab-active' : ''; ?>" href="<?php echo add_query_arg( array('tab' => 'licensing_plans'), $_SERVER['REQUEST_URI'] ); ?>">Upgrade Now</a></td>
                <td> <a id="miniorange_new" style="margin-top: 23px;background: #62B772;border-color: #62B772;color: white;" class="button"<?php echo $active_tab == 'miniorange_new' ? 'nav-tab-active' : ''; ?>" href="<?php echo add_query_arg( array('tab' => 'miniorange_new'), $_SERVER['REQUEST_URI'] ); ?>">What's new in miniOrange</a></td>
                <td>
                    <a id="mo_openid_rateus_modal" onclick="asdf(this)" style="margin-top: 23px" class="button" >Rate us</a>
                </td>
                <td>
                    <button id="mo_openid_restart_gtour" style="margin-top: 23px;background: #0867B2;border-color: #0867B2;color: white; float: right" class="button" onclick="window.location= base_url+'/wp-admin/admin.php?page=mo_openid_settings&tab=config_apps';restart_tour()" value="Restart Tour">Restart Tour</button>
                </td>
            </tr>
        </table>
    </div>
    ...
    <div style="width: 100%" id="mo-main-content-div">
        <div id="mo_openid_menu_height" style="width: 15%; float: left; background-color: #32373C; border-radius: 15px 0px 0px 15px;">
            ...
            <div class="mo_openid_tab" style="width:100%; border-radius: 0px 0px 0px 15px;">
                <a id="config_apps" class="tablinks<?php if($active_tab=="config_apps") echo '_active';?>" href="<?php echo add_query_arg( array('tab' => 'config_apps'), $_SERVER['REQUEST_URI'] ); ?>">Configure Apps</a>
                <a id="customise_social_icons" class="tablinks<?php if($active_tab=="customise_social_icons") echo '_active';?>" href="<?php echo add_query_arg( array('tab' => 'customise_social_icons'), $_SERVER['REQUEST_URI'] ); ?>">Customise Social Login Icons</a>
                <a id="disp_opt" class="tablinks<?php if($active_tab=="disp_opt") echo '_active';?>" href="<?php echo add_query_arg( array('tab' => 'disp_opt'), $_SERVER['REQUEST_URI'] ); ?>">Display Options</a>
                <a id="redirect_opt" class="tablinks<?php if($active_tab=="redirect_opt") echo '_active';?>" href="<?php echo add_query_arg( array('tab' => 'redirect_opt'), $_SERVER['REQUEST_URI'] ); ?>">Redirect Options</a>
                <a id="registration" class="tablinks<?php if($active_tab=="registration") echo '_active';?>" href="<?php echo add_query_arg( array('tab' => 'registration'), $_SERVER['REQUEST_URI'] ); ?>">Registration</a>
                <a id="gdpr" class="tablinks<?php if($active_tab=="gdpr") echo '_active';?>" href="<?php echo add_query_arg( array('tab' => 'gdpr'), $_SERVER['REQUEST_URI'] ); ?>">GDPR <?php if($disable){?><span class="mo-openid-premium">PRO</span><?php } ?></a>
                <a id="domain_restriction" class="tablinks<?php if($active_tab=="domain_restriction") echo '_active';?>" href="<?php echo add_query_arg( array('tab' => 'domain_restriction'), $_SERVER['REQUEST_URI'] ); ?>">Domain Restriction<span class="mo-openid-premium">PRO</span></a>
                <a id="link_social_acc" class="tablinks<?php if($active_tab=="link_social_acc") echo '_active';?>" href="<?php echo add_query_arg( array('tab' => 'link_social_acc'), $_SERVER['REQUEST_URI'] ); ?>">Link Social Account<?php if($disable){?><span class="mo-openid-premium">PRO</span><?php } ?></a>
                <a id="profile_completion" class="tablinks<?php if($active_tab=="profile_completion") echo '_active';?>" href="<?php echo add_query_arg( array('tab' => 'profile_completion'), $_SERVER['REQUEST_URI'] ); ?>">Profile Completion</a>
                <a id="email_settings" class="tablinks<?php if($active_tab=="email_settings") echo '_active';?>" href="<?php echo add_query_arg( array('tab' => 'email_settings'), $_SERVER['REQUEST_URI'] ); ?>">Email Notification<span class="mo-openid-premium">PRO</span></a>
                <a id="recaptcha" class="tablinks<?php if($active_tab=="recaptcha") echo '_active';?>" href="<?php echo add_query_arg( array('tab' => 'recaptcha'), $_SERVER['REQUEST_URI'] ); ?>">Recaptcha<span class="mo-openid-premium">PRO</span></a>
                <a id="premium_features" class="tablinks<?php if($active_tab=="premium_features") echo '_active';?>" href="<?php echo add_query_arg( array('tab' => 'premium_features'), $_SERVER['REQUEST_URI'] ); ?>">Premium Features<span class="mo-openid-premium">PRO</span></a>
                <a id="integration" class="tablinks<?php if($active_tab=="integration") echo '_active';?>" href="<?php echo add_query_arg( array('tab' => 'integration'), $_SERVER['REQUEST_URI'] ); ?>">Integrations<span class="mo-openid-premium">PRO</span></a>
                <a id="shortcodes" class="tablinks<?php if($active_tab=="shortcodes") echo '_active';?>" href="<?php echo add_query_arg( array('tab' => 'shortcodes'), $_SERVER['REQUEST_URI'] ); ?>">Shortcodes</a>
                <a id="add_on" class="tablinks<?php if($active_tab=="add_on") echo '_active';?>" href="<?php echo add_query_arg( array('tab' => 'add_on'), $_SERVER['REQUEST_URI'] ); ?>">Add On</a>
                <a id="profile" class="tablinks<?php if($active_tab=="profile") echo '_active';?>" href="<?php echo add_query_arg( array('tab' => 'profile'), $_SERVER['REQUEST_URI'] ); ?>">User Profile</a>
            </div>
        </div>
        <style>
        ...
        <input type="button" id="myBtn" class="support-help-button" data-show="false" onclick="mo_openid_support_form(this)" value="NEED HELP">
    </div>
        ...
        <table>
            <tr>
                ...
                <td>&nbsp;<a style="text-decoration:none" href="https://plugins.miniorange.com/"
                             target="_blank"><h1 style="color: #c9302c">miniOrange Social Login</h1></a></td>
                <td> <a id="privacy" style="margin-top: 23px" class="button" <?php echo $active_tab == 'privacy_policy' ? 'nav-tab-active' : ''; ?>" href="<?php echo add_query_arg( array('tab' => 'privacy_policy'), $_SERVER['REQUEST_URI'] ); ?>">Privacy Policy</a></td>
                <td> <a id="faq" style="margin-top: 23px" class="button" <?php echo $active_tab == 'faq' ? 'nav-tab-active' : ''; ?> href="<?php echo add_query_arg( array('tab' => 'faq'), $_SERVER['REQUEST_URI'] ); ?>">FAQs</a></td>
                <td> <a id="forum" style="margin-top: 23px" class="button" <?php echo $active_tab == 'forum' ? 'nav-tab-active' : ''; ?>" href="https://wordpress.org/support/plugin/miniorange-login-openid/" target="_blank">Forum</a></td>
                <td> <a id="addon" style="margin-top: 23px;background: #FFA335;border-color: #FFA335;color: white;" class="button" <?php echo $active_tab == 'add_on' ? 'nav-tab-active' : ''; ?>" href="<?php echo add_query_arg( array('tab' => 'add_on'), $_SERVER['REQUEST_URI'] ); ?>">Add On</a></td>
        ...
        <div style="width: 15%; float: left; background-color: #32373C; border-radius: 15px 0px 0px 15px;">
            ...
            <div class="mo_openid_tab" style="min-height:395px;width:100%; height: 445px;border-radius: 0px 0px 0px 15px;">
                <a id="social_apps" class="tablinks<?php if ($active_tab == "soc_apps") echo '_active'; ?>"
                   href="<?php echo add_query_arg(array('tab' => 'soc_apps'), $_SERVER['REQUEST_URI']); ?>">Select
                    Social Apps</a>
                <a id="customization"
                   class="tablinks<?php if ($active_tab == "customization") echo '_active'; ?>"
                   href="<?php echo add_query_arg(array('tab' => 'customization'), $_SERVER['REQUEST_URI']); ?>">Customization
                </a>
                <a id="share_cnt" class="tablinks<?php if ($active_tab == "share_cnt") echo '_active'; ?>"
                   href="<?php echo add_query_arg(array('tab' => 'share_cnt'), $_SERVER['REQUEST_URI']); ?>">Social
                    Share Counts</a>

                <a id="display_opt" class="tablinks<?php if ($active_tab == "display_opt") echo '_active'; ?>"
                   href="<?php echo add_query_arg(array('tab' => 'display_opt'), $_SERVER['REQUEST_URI']); ?>">Display
                    Option</a>
                <a id="short_code" class="tablinks<?php if ($active_tab == "short_code") echo '_active'; ?>"
                   href="<?php echo add_query_arg(array('tab' => 'short_code'), $_SERVER['REQUEST_URI']); ?>">Shortcodes</a>
...
function mo_comment_openid() {
    ...
    <div style="width: 100%">
        ...
        <div style="width: 15%; float: left; background-color: #32373C; border-radius: 15px 0px 0px 15px;">
            ...
            <div class="mo_openid_tab" style="min-height:395px;width:100%; height: 445px;border-radius: 0px 0px 0px 15px;">
                <a id="select_applications" class="tablinks<?php if($active_tab=="select_applications") echo '_active';?>" href="<?php echo add_query_arg( array('tab' => 'select_applications'), $_SERVER['REQUEST_URI'] ); ?>">Select Applications</a>
                <a id="display_options" class="tablinks<?php if($active_tab=="display_options") echo '_active';?>" href="<?php echo add_query_arg( array('tab' => 'display_options'), $_SERVER['REQUEST_URI'] ); ?>">Display options</a>
                <a id="customize_text" class="tablinks<?php if($active_tab=="customize_text") echo '_active';?>" href="<?php echo add_query_arg( array('tab' => 'customize_text'), $_SERVER['REQUEST_URI'] ); ?>">Customization</a>
                <a id="enable_comment" class="tablinks<?php if($active_tab=="enable_comment") echo '_active';?>" href="<?php echo add_query_arg( array('tab' => 'enable_comment'), $_SERVER['REQUEST_URI'] ); ?>">Enable and Add Social Comments</a>
                <a id="comment_shortcode" class="tablinks<?php if($active_tab=="comment_shortcode") echo '_active';?>" href="<?php echo add_query_arg( array('tab' => 'comment_shortcode'), $_SERVER['REQUEST_URI'] ); ?>">Shortcodes</a>
    ...
    <div style="width: 100%">
        ...
        <div style="width: 15%; float: left; background-color: #32373C; border-radius: 15px 0px 0px 15px;">
            ...
            <div class="mo_openid_tab" style="min-height:395px;width:100%; height: 445px;border-radius: 0px 0px 0px 15px;">
                ...
                <a id="mo_openid_licensing_plans_tab" class="tablinks<?php if($active_tab=="mo_openid_licensing_plans_tab") echo '_active';?>" href="<?php echo add_query_arg( array('tab' => 'mo_openid_licensing_plans_tab'), $_SERVER['REQUEST_URI'] ); ?>">Licensing Plans</a>
            </div>
        </div>
        <div id="mo_openid_settings" style="width: 85%; float: right;">
            <div style="background-color: #FFFFFF;width: 90%;border-radius: 0px 15px 15px 0px;">
