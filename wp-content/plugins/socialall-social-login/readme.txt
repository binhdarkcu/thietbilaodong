=== Plugin Name ===
Contributors: SocialAll Team
Donate link: https://wp.sociall.dev
...
<a target='_blank' href='https://wp.socialall.dev'>Click here to go to our site demo</a>
...
2. Rename unzipped folder to `sk-soclall-login`.
3. Upload the `sk-soclall-login` folder into the `/wp-content/plugins/` directory.
