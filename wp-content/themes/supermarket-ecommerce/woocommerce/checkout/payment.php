	...
	<?php if ( WC()->cart->needs_payment() ) : ?>
		<ul class="wc_payment_methods payment_methods methods">
			...
			if ( ! empty( $available_gateways ) ) {
				...
				echo '<li class="woocommerce-notice woocommerce-notice--info woocommerce-info">' . apply_filters( 'woocommerce_no_available_payment_methods_message', WC()->customer->get_billing_country() ? esc_html__( 'Xin lỗi, có vẻ như không có phương thức thanh toán có sẵn cho vị trí của bạn. Vui lòng liên hệ với chúng tôi nếu bạn cần hỗ trợ hoặc muốn sắp xếp thay thế.', 'woocommerce' ) : esc_html__( 'Vui lòng điền thông tin của bạn ở trên để xem các phương thức thanh toán có sẵn.', 'woocommerce' ) ) . '</li>'; // @codingStandardsIgnoreLine
			}
			?>
		</ul>
	<?php endif; ?>
